...
import com.ansela.foodapp.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detailBinding.tvCarbo.text=dataRecipes.protein
        detailBinding.tvDescription.text=dataRecipes.description
